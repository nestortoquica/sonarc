...
let OrderClientComponent = class OrderClientComponent {
    constructor(retailService, translate) {
        ...
        this.sdate = new Date(this.adate.setMonth(this.adate.getMonth() - 1)); // Fecha actual menos un mes
        this.fdate = new Date();
    ...
    ngOnInit() {
        ...
        this.columns2 = ['order', 'tracking', 'lockerID', 'email', 'employeId', 'doors', 'compartment', 'status', 'inLocker', 'pickedUp', 'signature', 'pickupCode'];
    }
    getText() {
        return __awaiter(this, void 0, void 0, function* () {
            this.deliveries = yield this.translate.get('deliveries').toPromise();
            this.general = yield this.translate.get('general').toPromise();
        });
    }
    getData() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            this.res = yield this.retailService.getAllOrders(data);
            let d;
            this.orderMonths = [];
            let l = 0;
            let m = 0;
    ...
    generalChart() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            this.mostActiveLockers = yield this.retailService.getMostActiveLocker(data);
    ...
    createSeries(field, name, stacked, chart, length) {
...
OrderClientComponent = __decorate([
    Component({
        selector: 'app-order',
...
export { OrderClientComponent };
//# sourceMappingURL=order-client.component.js.map
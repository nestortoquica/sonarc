...
let LockersGridComponent = class LockersGridComponent {
    constructor(ServerUserService) {
        ...
        this.tt_available = 0;
        this.tt_damaged = 0;
        this.id_locker = this.ServerUserService.getIdLocker();
    }
    ngOnInit() {
        this.data = {
            ...
            this.ServerUserService.get_query_door_locker_grid(this.data).subscribe(res => {
                ...
                this.res.modulo_status.forEach(modules => {
                    ...
                    modules.DOOR.forEach(door => {
                        ...
                        //totales
                        if (door.GRID.class == "LOCKER_ABIERTO") {
                            this.tt_open++;
                        }
                        if (door.GRID.class == "LOCKER_OCUPADO") {
                            this.tt_occupied++;
                        }
                        if (door.GRID.class == "LOCKER_CERRADO") {
                            this.tt_available++;
                        }
                        if (door.GRID.class == "LOCKER_FALLO") {
                            this.tt_damaged++;
                        }
                        count_item++;
                    });
...
LockersGridComponent = __decorate([
    Component({
...
export { LockersGridComponent };
//# sourceMappingURL=lockers-grid.component.js.map